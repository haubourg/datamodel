-- this delta file adds hstore and json fields on network elements as a proof of concept for easier storage of local specific information
-- the aim of this prototype is to evaluate if this could adress most customization requirements without having to deploy a QWAT-like meta generation for views.
